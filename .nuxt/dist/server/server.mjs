...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  __vite_ssr_import_7__.ssrRenderList($setup.cartItems, (item, index) => {
    ...
    }</h4></div></td><td data-v-f6c0e60a><div class="flex items-center bg-[#f4f4f4] rounded w-14" data-v-f6c0e60a><input class="bg-transparent font-bold text-center w-full" type="number"${
...
const personalDetails = __vite_ssr_import_2__.computed(() => {
...
const __returned__ = { cartStore, cartItems, form, personalDetails, totalCost, emit, closeModal, useCartStore: __vite_ssr_import_3__.useCartStore }
Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true })
return __returned__
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(__vite_ssr_import_5__.ssrRenderComponent(_component_custom_button, {
    disabled: !$setup.personalDetails,
    class: "mt-6 w-full uppercase",
    "btn-bg": '#13183f',
