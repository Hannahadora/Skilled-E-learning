...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${__vite_ssr_import_3__.ssrRenderAttrs(__vite_ssr_import_2__.mergeProps({ class: "lg:mb-[40px]" }, _attrs))} data-v-0aec5c06>`)
  ...
  _push(`</div><div class="md:h-[750px] h-[450px] md:w-[50%] w-[100%] mt-[-0px] overflow-hidden" data-v-0aec5c06><div class="hero md:mr-[-300px] md:mt-[-120px] mt-[-70px]" data-v-0aec5c06></div></div></div></div></div>`)
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div>`)
  if ($setup.cartModal) {
    _push(`<div class="lg:w-[45%] w-[100%] absolute top-24 lg:right-[100px] right-[0] z-50" data-v-3af7bf0c>`)
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_7__.ssrRenderAttrs(__vite_ssr_import_6__.mergeProps({ class: "relative" }, _attrs))} data-v-f6c0e60a><div class="w-full bg-[#fff] rounded-lg p-3 shadow lg:h-[440px] h-[500px]" data-v-f6c0e60a><div class="border-b pb-6" data-v-f6c0e60a><span class="font-bold text-[18px]" data-v-f6c0e60a>Cart</span></div><div class="w-full lg:h-[250px] h-[300px] overflow-scroll" data-v-f6c0e60a><table class="text-sm w-full" data-v-f6c0e60a><tr class="border-b" data-v-f6c0e60a><th data-v-f6c0e60a>SN</th><th class="text-left" data-v-f6c0e60a>Item</th><th class="text-left" data-v-f6c0e60a>Qty</th><th class="text-left" data-v-f6c0e60a>Unit price (\$)</th><th class="text-right" data-v-f6c0e60a>Total (\$)</th><th class="text-right" data-v-f6c0e60a>Action</th></tr><!--[-->`)
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_7__.ssrRenderAttrs(__vite_ssr_import_6__.mergeProps({ class: "" }, _attrs))} data-v-0ade75f6><div class="pb-4 border-b flex items-start justify-between" data-v-0ade75f6><span class="font-bold text-2xl" data-v-0ade75f6>Checkout Form</span><img class="w-7 h-7 cursor-pointer" src="/images/x.svg" alt="" data-v-0ade75f6></div><div class="w-full grid md:grid-cols-2 grid-cols-1 gap-6 my-6" data-v-0ade75f6><form class="w-full flex flex-col border-r pr-6" data-v-0ade75f6><h4 data-v-0ade75f6>Personal Information</h4>`)
  ...
  _push(`</form><div data-v-0ade75f6><h4 class="mb-[10px]" data-v-0ade75f6>Cart Details</h4><ul class="flex flex-col md:max-h-[400px] max-h-[200px] overflow-y-scroll px-[8px]" data-v-0ade75f6><!--[-->`)
  __vite_ssr_import_7__.ssrRenderList($setup.cartItems, (item, index) => {
...
const __returned__ = { emit, router, closeModal, useRouter: __vite_ssr_import_1__.useRouter }
Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true })
return __returned__
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_3__.ssrRenderAttrs(__vite_ssr_import_2__.mergeProps({ class: "h-[200px] rounded bg-white" }, _attrs))}><div class="flex flex-col items-center justify-center h-full"><div class="text-center text-[32px] font-serif font-bold text-[#000]">Success!!!</div><div class="font-text-[24px] mt-[16px] text-[#000]"> Your item will arrive in 7 working days </div>`)
  _push(__vite_ssr_import_3__.ssrRenderComponent(_component_custom_button, {
    ...
    default: __vite_ssr_import_2__.withCtx((_, _push, _parent, _scopeId) => {
      if (_push) {
        ...
        return [
          __vite_ssr_import_2__.createTextVNode("Done")
        ]
      }
    }),
    _: 1 /* STABLE */
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_5__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/DELL/Desktop/My Vues/e-skills/components/SuccessScreen.vue"]]);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${
    __vite_ssr_import_3__.ssrRenderAttrs(__vite_ssr_import_2__.mergeProps({ class: "grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[50px]" }, _attrs))
...
__vite_ssr_exports__.default = ".card-icon[data-v-f883d62a],.modal-card-icon[data-v-f883d62a]{position:absolute;top:-16px}.modal-card-icon[data-v-f883d62a]{background:rgba(0,0,0,.551);border-radius:100%;display:none!important}.main-card[data-v-f883d62a]{background:#fff;border-radius:16px;height:300px;max-width:400px;padding:24px;position:relative;text-align:center}@media screen and (max-width:768px){.main-card[data-v-f883d62a]{max-width:none}}.modal-wrapper[data-v-f883d62a]{align-items:center;background:rgba(0,0,0,.551);border-radius:16px;display:none!important;display:flex;height:100%;justify-content:center;left:0;position:absolute;top:0;width:100%}.modal-content[data-v-f883d62a]{background:#fff}.main-card:hover .modal-card-icon[data-v-f883d62a],.main-card:hover .modal-wrapper[data-v-f883d62a]{display:block!important}";
}
