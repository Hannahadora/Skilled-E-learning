...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="flex items-center justify-end mt-6 px-8 text-xl"><h6 class="font-bold">Total:</h6><h6 class="ml-4 font-bold">\$ ${__vite_ssr_import_7__.ssrInterpolate($setup.totalCost)}</h6></div><div class="flex items-center justify-center">`)
...
const __vite_ssr_import_8__ = await __vite_ssr_import__("/components/Cart.vue?vue&type=style&index=0&lang.css");
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_10__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"C:/Users/DELL/Desktop/My Vues/e-skills/components/Cart.vue"]]);
}
...
const __returned__ = { cartStore, cartItems, totalCost, emit, closeModal, useCartStore: __vite_ssr_import_3__.useCartStore }
Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true })
return __returned__
}
